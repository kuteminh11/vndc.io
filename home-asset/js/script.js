(function ($) {
    ...
    function myFunction()
    {
        ...
        $("#preloader").attr('style', 'width:'+width+'px');
        $(".header-area").attr('style', 'width:'+width+'px');
        $(".hero-section").attr('style', 'width:'+width+'px');
        $(".special").attr('style', 'width:'+width+'px');
        $(".about-us-area").attr('style', 'width:'+width+'px');
        $(".footer-area").attr('style', 'width:'+width+'px');
    }
